                        ...
                        <td style="width: 50%">
                           <table border="0" style="width: 100%;float: left;text-align: left;border-color:;margin: 0 0 0px;">
                              ...
                              <td style="padding: 0px;width:20%;vertical-align: middle;">
                                    <img src="{{asset('assets/media/mail/ban.png')}}" style="margin: auto;display: block;">
                                 </td>
                           </tbody></table>
                        </td>
                     </tr>
                           ...
                           <td style="width:100%;float: left;">
                              <table width="100%" cellpadding="5" border="0" style="border: none;">
                                 <tbody>
                                   ...
                                   <tr style="width: 100%">
                                       <th style="font-size:19px;line-height: 28px;font-weight: 600;color: #000;padding: 5px 0px;text-align:center;">Hi  {{ ucfirst($order->kitchen->name) }},Your Order ({{ $order->invoice_prefix . $order->id }}) Has Been Cancelled</th>
                                    </tr>
                                    <tr style="width: 100%">
                                     
                                       <th style="font-size:14px;line-height: 25px;font-weight:400;color:#504848;padding: 5px 0px;text-align:center;">
                                            Cancelled Reason: {{ $order->histories[0]->comment}}<br></th>
                                    </tr>
                                 </tbody>
                              </table>
                           </td>
                  ...
                  <tbody>
                     ...
                     <tr style="width: 100%;background: #2f3f4e;">
                        <td style="font-size: 13px;line-height: 20px;font-weight: 400;color: #fff; text-align: center;     border: #fff;">
                           Copyrights 2021 The Chef. All rights reserved 
                        </td>
                     </tr>
                  </tbody>
               </table>

                                ...
                                <tbody><tr style="width: 100%;">
                                  ...
                                  <td style="width:100%;float: left;">
                                    <table width="100%" cellpadding="5" border="0" style="border: none;">
                                      <tbody>
                                        <tr style="width: 100%">
                                        <th style="font-size: 20px;line-height: 25px;font-weight: 600;color:#4f8a10;padding: 5px 0px;text-align:center;">Congratulations {{ ucfirst($order->kitchen->name) }} ! A new order  has been placed</th>
                                      </tr>

                                        <tr style="width: 100%">
                                        <th style="font-size:15px;line-height: 25px;font-weight:400;color:#504848;padding: 5px 0px;text-align:center;"> Order details are as follows.</th>
                                      </tr>

                           ...
                           <td style="width:100%;float: left;">
                              <table width="100%" cellpadding="5" border="0" style="border: none;">
                                 <tbody>
                                   ...
                                   <tr style="width: 100%">
                                       <th style="font-size:19px;line-height: 28px;font-weight: 600;color: #000;padding: 5px 0px;text-align:center;">Hi  {{ ucfirst($order->customer->name) }},Your Order Has Been Cancelled</th>
                                    </tr>
                                    <tr style="width: 100%">
                                     
                                       <th style="font-size:14px;line-height: 25px;font-weight:400;color:#504848;padding: 5px 0px;text-align:center;">
                                            Cancelled Reason: {{ $order->histories[0]->comment}}<br> Thank you for your Time <br>We are so happy to have you here with us.</th>
                                    </tr>
                                 </tbody>
                              </table>
                           </td>

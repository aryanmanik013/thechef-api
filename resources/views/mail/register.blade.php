                           ...
                           <table border="0" style="width: 100%;float: left;text-align: left;border-color:;margin: 0 0 0px;">
                              <tbody><tr style="width: 100%">
                                 <td style="width:20%;vertical-align: middle;">
                                    <img src="{{asset('assets/media/mail/bg1.png')}}" style="width:100%;">
                                 </td>
                              </tr>
                           </tbody></table>
                        </td>
                        ...
                        <tr style="width: 100%;">
                           <td style="width:100%;float: left;">
                              <table width="100%" cellpadding="5" border="0" style="border: none;">
                                 <tbody>
                                    <tr style="width: 100%">
                                       <th style="font-size:19px;line-height: 28px;font-weight: 600;color: #000;padding: 5px 0px;text-align:center;">Hi {{ ucfirst($customer->name) }}, Welcome To The Chef</th>
                                    </tr>
                                    <tr style="width: 100%">
                                       <th style="font-size:14px;line-height: 25px;font-weight:400;color:#504848;padding: 5px 0px;text-align:center;"> Thank you for creating your account at The Chef! We are so happy to have you here with us.</th>
                                    </tr>
                                 </tbody>
                              </table>
                           </td>

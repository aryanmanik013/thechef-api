...
<div class="card card-custom bg-gray-100 card-stretch gutter-b">
    <!--begin::Header-->
    <div class="card-header border-0 bg-danger py-5" style="background:#e39724 !important;">
    ...
    <div class="card-body p-0 position-relative overflow-hidden">
        <!--begin::Chart-->
        <div id="" class="card-rounded-bottom bg-danger" style="background:#e39724 !important;height: 200px"></div>
        <!--end::Chart-->
        ...
        <div class="card-spacer mt-n25">
            ...
            <div class="row m-0">
                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="{{route('admin.report')}}" class="text-warning font-weight-bold font-size-h6">
                ...
                <a href="{{route('admin.customer.index')}}" class="text-primary font-weight-bold font-size-h6 mt-2">
            ...
            <div class="row m-0">
                ...
                <a href="{{route('admin.order.index')}}" class="text-danger font-weight-bold font-size-h6 mt-2">
                ...
                <div class="col bg-light-success px-6 py-8 rounded-xl">
                    ...
                    </svg><!--end::Svg Icon--></span>                    <a href="{{route('admin.kitchen.index')}}" class="text-success font-weight-bold font-size-h6 mt-2">
                        Total Kitchens({{ $kitchen_count }})
                    </a>
                </div>
            </div>
            <!--end::Row-->
...
<div class="card card-custom card-stretch gutter-b">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        <h3 class="card-title align-items-start flex-column">
            <span class="font-weight-bolder text-dark">Pending Approvals</span>
    ...
    <!--begin::Body-->
    <div class="card-body pt-4" style="height: 440px;    overflow-y: scroll;">
       ...
       @foreach($recent_activites as  $recent_activity)
                    ...
                    <div class="timeline-item align-items-start">
                        <!--begin::Label-->
                        <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg">{{$recent_activity['created_at']}}</div>
                        <!--end::Label-->
                        ...
                        <div class="timeline-content d-flex">
                            ...
                            <a href="{{$recent_activity['type'] == 1 ? route('admin.kitchen.index') : route('admin.delivery-partner.index') }}">
                            <span class="font-weight-bolder text-dark-75 pl-3 font-size-lg">{{$recent_activity['message']}}</span></a>
                        </div>
                        <!--end::Content-->
                    </div>
                    <!--end::Item-->
...
<script type="text/javascript">
   ...
   $(function() {
     ...
     $customerTable= $('#order-table').DataTable({

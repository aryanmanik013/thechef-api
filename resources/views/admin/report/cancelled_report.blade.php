...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <span class="text-muted font-weight-bold mr-4">Cancelled Orders</span>
	...
	<!--begin::Entry-->
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="card card-custom">
									...
									<div class="card-body">
									    <form method="POST" action="{{  route('admin.cancelledReportFilter') }}">
									       @csrf 
            ...
            <div class="row m-0">
                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a id="totalSales" href="#" class="text-warning font-weight-bold font-size-h6">
                        Total Amount ({{$reports->sum('total')}})
                    </a>
                </div>
